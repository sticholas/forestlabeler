...
Track A canopy verification should use `docs/operations/TRACK_A_QGIS_VERIFICATION.md` so plugin loading, validation, canopy creation, metadata, species decisions, review controls, and QA selection are checked consistently before closing production canopy work.
